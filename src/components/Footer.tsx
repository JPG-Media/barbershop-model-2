...
const Navbar = () => {
  ...
  return (
      <section className=" w-full flex justify-between items-center relative mx-auto ">
        <nav className="md:gap-10 gap-4 relative w-full flex  items-center justify-between py-8">
