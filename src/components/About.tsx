...
const About = () => {
  return (
    <div className="w-full flex  justify-center items-center px-2 md:px-10 md:py-10 gap-8 relative  min-h-[60vh] drop-shadow-[3px_-4px_0px_rgba(255,255,255,1)] bg-black rounded-tl-3xl rounded-br-3xl mt-10">
      <div className="w-full flex flex-col md:flex-row justify-between items-center lg:px-24 sm:px-10 px-4 sm:py-10 py-4  h-full rounded-tl-3xl rounded-br-3xl ">
