...
const NavbarLeftItems = () => {
  return (
    <div className="container px-4 w-full flex flex-wrap items-center justify-center">
      <ul className="flex justify-end gap-3 list-none w-full text-lg xl:text-2xl text-white font-text font-light ">
        <motion.li>
          <motion.a
