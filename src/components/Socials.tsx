...
const Socials = () => {
  return (
    <div className="md:p-0 w-full flex flex-col">
      ...
      p-4 rounded-tl-3xl rounded-br-[45px] gap-5 drop-shadow-[3px_-4px_0px_rgba(255,255,255,1)] bg-black"
      >
        ...
        <div className="md:w-2/5 w-full  rounded-tl-3xl rounded-br-3xl">
          <img
            ...
            className="rounded-tl-2xl border-solid border-[3px] border-secondary rounded-br-2xl w-full h-full object-cover"
            alt="place"
          />
        </div>
      </div>
      ...
      <div className="py-10 flex flex-col md:flex-row justify-center items-center md:items-start text-center gap-5">
        <div className="p-10 border-solid border-2 border-primary rounded-bl-3xl text-white font-bold text-4xl font-logo">
          <h1>
        ...
        <div className="p-10 border-solid border-2 border-secondary rounded-br-3xl text-white font-bold text-4xl font-logo">
